# Master Technical Architecture & Visual Engineering Specification

**Project Name**: UNIKOM KKN Berdampak 2026 — Kecamatan Coblong, Kota Bandung  
**Document Code**: `SPEC-UNIKOM-KKN-2026-V1`  
...
**Target Quality Level**: Immersive Garden Studio Grade & Photometric Color Science Standard  
...
| # | Nama Komponen SFC | Path Berkas Sumber / Replikasi | Peran & Tanggung Jawab Teknis |
| :--- | :--- | :--- | :--- |
| 1 | **Root Shell (`app.vue`)** | `app.vue` (`/application/index.vue`) | Kontainer utama antarmuka, pengelola stacking context global (`z-index: 1..3`), mounting laci modal. |
...
* **Geometry & Texture Projection**: Tekstur fotografik 2D dipetakan di atas geometri 3D plane ortografis (*Skeuomorphic Photo-Plane Shading*).
...
### Act II — Government Helix: Institutional SDG 11 Alignment
...
* **Structural Target**: Integrasi formal program pengabdian masyarakat UNIKOM dengan Tri Dharma Perguruan Tinggi.

### Act IV — Society Helix: Micro-Empowerment Field Execution

* **Structural Target**: Pelaksanaan pemberdayaan masyarakat di wilayah Kecamatan Coblong (Sadang Serang, Sekeloa, Dago, Cipaganti, Lebak Gede, Lebak Siliwangi).
...
* **Structural Target**: Kerangka kerja Tanggung Jawab Sosial Perusahaan (CSR) dan matriks kemitraan industri.

### Act VI — Media Helix: Endless Masonry Stream Gallery

* **Visual Architecture**: Grid masonry asinkron modus gelap dengan matriks aliran tak terbatas (*Endless Masonry Matrix*).

---

## 6. 3D Mesh Geometry & Asset Manifest
...
### 8.1 Complete Color Ledger System (15 Citrix Hex + 8 SWD Modal Briefing Hex)
...
### 8.2 Matriks Complete 8 Teknik Pencahayaan Fotometrik (Citrix Baseline)
...
### 9.3 Manifes Complete 6 Tipografi Ter-Preload (Citrix & Sustainable Web Design)
...
## 10. Post-Trigger UI Architecture & SDG 11 Specification
...
### 10.3 Sistem Spasial & Tipografi Laci Briefing
